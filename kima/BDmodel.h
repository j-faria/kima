...
namespace kima
{
    ...
    private:
        ...
        /// Maximum number of planets (by default 4)
        int npmax{4};

        DNest4::RJObject<RVMixtureConditionalPrior> planets =
            DNest4::RJObject<RVMixtureConditionalPrior>(6, npmax, true, RVMixtureConditionalPrior());
