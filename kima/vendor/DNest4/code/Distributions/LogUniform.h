...
namespace DNest4
{
    ...
    /*
     * LogUniform distribution (reciprocal)
    */
    ...
    public:
        ...
        void setpars(double lower, double upper);
    ...
    /*
     * Modified LogUniform distribution (support down to 0)
    */
    ...
    public:
        ...
        void setpars(double knee, double upper);
